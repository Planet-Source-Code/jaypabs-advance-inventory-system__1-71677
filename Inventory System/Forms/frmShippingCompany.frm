...
Begin VB.Form frmShippingCompany 
   Caption         =   "Forwarders"
   ClientHeight    =   2895
   ClientLeft      =   3240
   ClientTop       =   2385
   ...
   End
End
Attribute VB_Name = "frmShippingCompany"
...
Dim rsShippingCompany As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmShippingCompanyAE.State = adStateAddMode
            frmShippingCompanyAE.show vbModal
        Case "Edit"
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Shipping_Company", "ShippingCompanyID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
      .Fields = "ShippingCompany, Area, City, Telephone, Mobile, ShippingCompanyID"
      .Tables = "Shipping_Company"
      .SortOrder = "ShippingCompany ASC"
      
      .SaveStatement
    End With
    
    rsShippingCompany.CursorLocation = adUseClient
    rsShippingCompany.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsShippingCompany, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsShippingCompany, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "ShippingCompanyID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmShippingCompany = Nothing
End Sub
