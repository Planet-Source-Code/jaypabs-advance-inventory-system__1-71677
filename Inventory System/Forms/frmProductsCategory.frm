...
Begin VB.Form frmProductsCategory 
   ...
   End
End
Attribute VB_Name = "frmProductsCategory"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmProductsCategoryAE.State = adStateAddMode
            frmProductsCategoryAE.show vbModal
        Case "Edit"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmProductsCategory = Nothing
End Sub
