...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmLedgerAE.State = adStateAddMode
            frmLedgerAE.show vbModal
        Case "Edit"
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Company, OwnersName, Address, Landline, CreditTerm, PurchaserName, ClientID"
        .Tables = "qry_Clients"
