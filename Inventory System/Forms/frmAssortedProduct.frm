...
Begin VB.Form frmAssortedProduct 
   ...
   Begin VB.Label lblTitle 
      BackStyle       =   0  'Transparent
      Caption         =   "Assorted Product Records"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmAssortedProduct"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmAssortedProductAE.State = adStateAddMode
            frmAssortedProductAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Assorted_Product", "AssortedProductID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "This record has been removed by other user.Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    With frmAssortedProductAE
                        Dim blnStatus As Boolean
                        
                        blnStatus = getValueAt("SELECT AssortedProductID,Status FROM Assorted_Product WHERE AssortedProductID=" & CLng(LeftSplitUF(lvList.SelectedItem.Tag)), "Status")
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Assorted_Product", "AssortedProductID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Stock, Qty, Date, Status_Alias,  AssortedProductID"
        .Tables = "qry_Assorted_Product"
        .SortOrder = "Date DESC"
        
        .SaveStatement
    End With
    If RSAssorted.State = 1 Then RSAssorted.Close
    RSAssorted.CursorLocation = adUseClient
    RSAssorted.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, RSAssorted, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "AssortedProductID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmAssorted_Product = Nothing
End Sub
