...
Begin VB.Form frmProductsUOM 
   ...
   End
End
Attribute VB_Name = "frmProductsUOM"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmProductsUOMAE.State = adStateAddMode
            frmProductsUOMAE.show vbModal
        Case "Edit"
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Unit,AddCharges,Groupings,UnitID"
        .Tables = "Unit"
        .SortOrder = "Unit ASC"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsUnit, RecordPage.PageStart, RecordPage.PageEnd, 3, 2, False, True, , , , "UnitID")
    Me.Enabled = True
