...
Begin VB.Form frmLocalForwarder 
   ...
   End
End
Attribute VB_Name = "frmLocalForwarder"
...
Dim rsLocalForwarder As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmLocalForwarderAE.State = adStateAddMode
            frmLocalForwarderAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Local_Forwarder", "LocalForwarderID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "This record has been removed by other user.Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    With frmLocalForwarderAE
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Local_Forwarder", "LocalForwarderID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
      .Fields = "LocalForwarder, Area, City, Telephone, Mobile, LocalForwarderID"
      .Tables = "Local_Forwarder"
      .SortOrder = "LocalForwarder ASC"
      
      .SaveStatement
    End With
    If rsLocalForwarder.State = 1 Then rsLocalForwarder.Close
    rsLocalForwarder.CursorLocation = adUseClient
    rsLocalForwarder.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsLocalForwarder, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsLocalForwarder, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "LocalForwarderID")
    Me.Enabled = True
