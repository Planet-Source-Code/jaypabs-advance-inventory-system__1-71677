...
Begin VB.Form frmRoutes 
   ...
   Begin VB.Label lblTitle 
      BackStyle       =   0  'Transparent
      Caption         =   "Locations / Area Records"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmRoutesAE.State = adStateAddMode
            frmRoutesAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Routes", "RouteID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Routes", "RouteID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Route, Desc, Area, RouteID"
        .Tables = "Routes"
        .SortOrder = "Route ASC"
        
        .SaveStatement
    End With
    If rsRoutes.State = 1 Then rsRoutes.Close
    rsRoutes.CursorLocation = adUseClient
    rsRoutes.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsRoutes, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "RouteID")
    Me.Enabled = True
