VERSION 5.00
Begin VB.Form frmSuppliersLocationAE 
   ...
   End
End
Attribute VB_Name = "frmSuppliersLocationAE"
...
Private Sub Form_Load()
    ...
    rs.Open "SELECT * FROM Vendors_Location WHERE LocationID = " & PK, CN, adOpenStatic, adLockOptimistic
...
Private Sub Form_Unload(Cancel As Integer)
    If HaveAction = True Then
        If State = adStateAddMode Or adStateEditMode Then
            frmSuppliersLocation.RefreshRecords
        End If
    End If
    
    Set frmSuppliersLocationAE = Nothing
End Sub
