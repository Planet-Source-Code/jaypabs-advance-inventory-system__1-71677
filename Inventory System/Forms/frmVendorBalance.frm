...
Begin VB.Form frmVendorBalance 
   Caption         =   "Vendors w/ Balance"
   ClientHeight    =   6630
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   9315
   ...
   End
End
Attribute VB_Name = "frmVendorBalance"
        ...
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Vendors", "VendorID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    ...
                    Exit Sub
                Else
                    With frmPayVendorBills
                        '.State = adStateEditMode
                        .PK = CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        .strRefNo = lvList.SelectedItem
                        .strVendor = lvList.SelectedItem.SubItems(1)
                        .ForwarderPK = lvList.SelectedItem.SubItems(5)
                        .blnNew = True
                        .TotalAmount = lvList.SelectedItem.SubItems(3)
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "RefNo, Company, Owner, Balance, DueDate, POID, VendorID"
        .Tables = "qry_Vendor_Balance_Per_Forwarder"
        .SortOrder = "DueDate ASC"
        
        .SaveStatement
    End With
    
    If rsVendors.State = 1 Then rsVendors.Close
