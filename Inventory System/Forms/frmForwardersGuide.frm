...
Begin VB.Form frmForwardersGuide 
   ...
   End
End
Attribute VB_Name = "frmForwardersGuide"
...
Dim rsShippingGuide As New Recordset
    ...
    Select Case srcPerformWhat
        ...
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Forwarders", "ForwarderID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                ...
                Else
                    With frmForwardersGuideAE
                        ...
                        ForwarderID = CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        
                        blnLocked = getValueAt("SELECT Locked FROM Forwarders WHERE ForwarderID=" & ForwarderID, "Locked")
                        ...
                        CN.Execute "UPDATE Forwarders SET Locked = True WHERE ForwarderID = " & ForwarderID
                        
                        blnStatus = getValueAt("SELECT ForwarderID,Status FROM Forwarders WHERE ForwarderID=" & ForwarderID, "Status")
                        ...
                        .ForwarderPK = ForwarderID
                        .show vbModal
                        
                        CN.Execute "UPDATE Forwarders SET Locked = False WHERE ForwarderID = " & ForwarderID
                    End With
                End If
            End If
        Case "Search"
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "ShippingCompany, Company, Ref, RefNo, QtyDue, PickupLocation, PickupDate, ForwarderID"
        .Tables = "qry_Forwarders"
        .SortOrder = "DeliveryDate DESC"
        
        .SaveStatement
    End With
    
    rsShippingGuide.CursorLocation = adUseClient
    rsShippingGuide.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsShippingGuide, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsShippingGuide, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "ForwarderID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmForwardersGuide = Nothing
End Sub
