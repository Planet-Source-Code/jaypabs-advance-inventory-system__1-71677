...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmSalesReturnAE.State = adStateAddMode
            frmSalesReturnAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Sales_Return", "SalesReturnID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                ...
                Else
                    With frmSalesReturnAE
                        ...
                        blnStatus = getValueAt("SELECT SalesReturnID,Status FROM Sales_Return WHERE SalesReturnID=" & CLng(LeftSplitUF(lvList.SelectedItem.Tag)), "Status")
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Sales_Return", "SalesReturnID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Company, Date, Notes, Gross, NetAmount, SalesReturnID"
        .Tables = "qry_Sales_Return"
        .SortOrder = "Date DESC"
    ...
    RSSalesReturn.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start RSSalesReturn, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, RSSalesReturn, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "SalesReturnID")
    Me.Enabled = True
