...
Begin VB.Form frmPOReceiveLocal 
   ...
   End
End
Attribute VB_Name = "frmPOReceiveLocal"
    ...
    Select Case srcPerformWhat
        ...
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Purchase_Order_Receive_Local", "InvoiceID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                ...
                Else
                    With frmPOReceiveLocalAE
                        ...
                        InvoiceID = CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        
                        blnLocked = getValueAt("SELECT Locked FROM Purchase_Order_Receive_Local WHERE InvoiceID=" & InvoiceID, "Locked")
                        ...
                        CN.Execute "UPDATE Purchase_Order_Receive_Local SET Locked = True WHERE InvoiceID = " & InvoiceID
                        
                        blnStatus = getValueAt("SELECT InvoiceID,Status FROM Purchase_Order_Receive_Local WHERE InvoiceID=" & InvoiceID, "Status")
                        ...
                        CN.Execute "UPDATE Purchase_Order_Receive_Local SET Locked = False WHERE InvoiceID = " & InvoiceID
                    End With
                End If
            End If
        Case "Search"
...
Private Sub Form_Load()
    ...
    With SQLParser
        ...
        .Tables = "qry_Purchase_Order_Receive_Local"
