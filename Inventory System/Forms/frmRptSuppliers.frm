...
Private Sub cmdPreview_Click()
    ...
    With frmReports
        .strReport = "Suppliers Report"

        If nsdVendor.Text = "" Then
            .strWhere = "{qry_rpt_Suppliers.DeliveryDate} IN #" & dtpBegDate.Value & "# TO #" & dtpEndDate.Value & "#"
        Else
            .strWhere = "{qry_rpt_Suppliers.VendorID} = " & nsdVendor.BoundText & " " _
                                & "AND {qry_rpt_Suppliers.DeliveryDate} IN #" & dtpBegDate.Value & "# TO #" & dtpEndDate.Value & "#"
        End If
