...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmBanksAE.State = adStateAddMode
            frmBanksAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Banks", "BankID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Banks", "BankID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Bank, Branch, BankID"
        .Tables = "Banks"
        .SortOrder = "Bank ASC"
        
        .SaveStatement
    End With
    If rsBanks.State = 1 Then rsBanks.Close
    rsBanks.CursorLocation = adUseClient
    rsBanks.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsBanks, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "BankID")
    Me.Enabled = True
