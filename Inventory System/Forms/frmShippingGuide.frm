...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmShippingGuideAE.State = adStateAddMode
            frmShippingGuideAE.show vbModal
        Case "Edit"
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "ShippingCompany, ShippingGuideNo, PONo, ArrivalDate, Ship, BLNo, VanNo, VoyageNo, DRNo, QtyDue, ForwarderID"
        .Tables = "qry_Forwarders"
        .SortOrder = "ArrivalDate DESC"
