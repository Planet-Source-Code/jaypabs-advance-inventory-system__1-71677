...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmAgentsAE.State = adStateAddMode
            frmAgentsAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Agents", "AgentID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Agents", "AgentID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "AgentName, AgentCode, Address, ContactNo, Commission,  AgentID"
        .Tables = "Agents"
        .SortOrder = "AgentName ASC"
        
        .SaveStatement
    End With
    If rsAgents.State = 1 Then rsAgents.Close
    rsAgents.CursorLocation = adUseClient
    rsAgents.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsAgents, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "AgentID")
    Me.Enabled = True
