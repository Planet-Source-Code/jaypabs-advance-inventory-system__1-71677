...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmExpensesAE.State = adStateAddMode
            frmExpensesAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Expenses", "ExpenseID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Expenses", "ExpenseID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Date, ExpenseType, Details, ExpenseID"
        .Tables = "Expenses"
        .SortOrder = "Date DESC"
        
        .SaveStatement
    End With
    If rsExpenses.State = 1 Then rsExpenses.Close
    rsExpenses.CursorLocation = adUseClient
    rsExpenses.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsExpenses, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "ExpenseID")
    Me.Enabled = True
