...
Begin VB.Form frmSalesReceipts 
   Caption         =   "Receipts"
   ClientHeight    =   6600
   ClientLeft      =   315
   ClientTop       =   5145
   ...
   End
End
Attribute VB_Name = "frmSalesReceipts"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmSalesReceiptsAE.State = adStateAddMode
            frmSalesReceiptsAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Receipts", "ReceiptID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                ...
                Else
                    With frmSalesReceiptsAE
                        ...
                        blnLocked = getValueAt("SELECT Locked FROM Receipts WHERE ReceiptID=" & CLng(LeftSplitUF(lvList.SelectedItem.Tag)), "Locked")
                        ...
                        blnStatus = getValueAt("SELECT ReceiptID,Status FROM Receipts WHERE ReceiptID=" & CLng(LeftSplitUF(lvList.SelectedItem.Tag)), "Status")
                        ...
                        Else
                            ...
                            CN.Execute "UPDATE Receipts SET Locked = True WHERE ReceiptID = " & CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        End If
                    
                        .PK = CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        .show vbModal
                        
                        CN.Execute "UPDATE Receipts SET Locked = False WHERE ReceiptID = " & CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
                    End With
                End If
            End If
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Receipts", "ReceiptID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Public Sub ReloadRecords(ByVal srcSQL As String)
    ...
    For I = 1 To lvList.ListItems.Count
        For j = 1 To 5
            If lvList.ListItems(I).SubItems(6) = "Yes" Then
                lvList.ListItems(I).ForeColor = vbRed
                lvList.ListItems(I).ListSubItems(j).ForeColor = vbRed
            End If
        Next
    Next
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "RefNo, City, Company, AgentName, DateIssued, Status_Alias, Deducted, Printed_Alias, ReceiptID"
        .Tables = "qry_Receipts"
        .SortOrder = "DateIssued DESC, ReceiptID DESC"
        .wCondition = "RouteID = 21"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, RSReceipts, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "ReceiptID")
    Me.Enabled = True
