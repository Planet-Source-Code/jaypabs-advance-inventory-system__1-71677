...
Begin VB.Form frmProductGroupings 
   ...
   End
End
Attribute VB_Name = "frmProductGroupings"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmProductGroupingsAE.State = adStateAddMode
            frmProductGroupingsAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Product_Groupings", "ProductGroupingID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "This record has been removed by other user.Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    With frmProductGroupingsAE
