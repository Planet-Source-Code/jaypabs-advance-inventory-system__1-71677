    ...
    Select Case srcPerformWhat
        ...
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Purchase_Order", "POID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                ...
                Else
                    With frmPurchaseOrderAE
                        ...
                        POID = CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        
                        blnLocked = getValueAt("SELECT Locked FROM Purchase_Order WHERE POID=" & POID, "Locked")
                        ...
                        CN.Execute "UPDATE Purchase_Order SET Locked = True WHERE POID = " & POID
                        
                        blnStatus = getValueAt("SELECT POID,Status FROM Purchase_Order WHERE POID=" & POID, "Status")
                        ...
                        CN.Execute "UPDATE Purchase_Order SET Locked = False WHERE POID = " & POID
                    End With
                End If
            End If
        Case "Search"
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Purchase_Order", "POID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Public Sub RefreshRecords()
  ...
  For I = 1 To lvList.ListItems.Count
    For j = 1 To 6
      If lvList.ListItems(I).SubItems(6) = False Then
...
Private Sub Form_Load()
    ...
    With SQLParser
      .Fields = "PONo, Company, Location, Date, QtyOrdered, QtyRcvd, QtyDue, Status_Alias, POID"
      .Tables = "qry_Purchase_Order"
      .wCondition = "((Purchase_Order.Date)>Date()-7)"
      .SortOrder = "Date DESC"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsPurchaseOrder, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "POID")
    Me.Enabled = True
