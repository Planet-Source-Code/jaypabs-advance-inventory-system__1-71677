    ...
    Select Case srcPerformWhat
        ...
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Salesman", "SalesmanID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Salesman", "SalesmanID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Salesman, Mobile, SalesmanID"
        .Tables = "Salesman"
        .SortOrder = "Salesman ASC"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsSalesman, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "SalesmanID")
    Me.Enabled = True
