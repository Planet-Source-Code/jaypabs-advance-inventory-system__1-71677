...
Private Sub Form_Load()
    ...
    With lvMenu
        ...
        'For Clients
        .ListItems.Add , "frmCustomers", "Customers", 1, 1
        .ListItems.Add , "frmCustomerBalance", "Customers w/ balance", 1, 1
        
        'For Vendors
        .ListItems.Add , "frmSuppliers", "Suppliers", 4, 4
        
        'For Stocks
        .ListItems.Add , "frmProducts", "Products", 6, 6
        
        'For Sales
        .ListItems.Add , "frmSalesReceipts", "Sales Receipts", 14, 14
        .ListItems.Add , "frmSalesReceiptsBatch", "Sales Receipts by Batch", 14, 14
        
        'For Purchases
        .ListItems.Add , "frmPurchaseOrder", "Purchase Order", 6, 6
        .ListItems.Add , "frmForwardersGuide", "Forwarders Guide", 6, 6
        .ListItems.Add , "frmPOReceiveLocal", "Receive Stock Local", 6, 6
        .ListItems.Add , "frmForwardersReceive", "Receive Stock Out of Town", 6, 6

        'For Collection
        .ListItems.Add , "frmCollection", "Collection", 5, 5
    End With
End Sub
