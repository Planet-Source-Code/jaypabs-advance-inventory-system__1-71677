...
Begin VB.Form frmCustomersCategory 
   ...
   Begin VB.Label lblTitle 
      BackStyle       =   0  'Transparent
      Caption         =   "Customers Category List"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmCustomersCategory"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmCustomersCategoryAE.State = adStateAddMode
            frmCustomersCategoryAE.show vbModal
        Case "Edit"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCustomersCategory = Nothing
End Sub
