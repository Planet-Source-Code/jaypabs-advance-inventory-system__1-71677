...
Begin VB.Form frmForwardersGuideAE 
   ...
   Begin VB.TextBox txtTotalTranspoCost 
      BackColor       =   &H00E6FFFF&
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmShippingGuideAE.frx":0000
      ...
      TabPicture(1)   =   "frmShippingGuideAE.frx":001C
      ...
      Tab(1).Control(5)=   "cboAmbot"
      Tab(1).Control(6)=   "txtReceipt"
      Tab(1).Control(7)=   "txtCheckNo"
      ...
      Begin VB.ComboBox cboAmbot 
         Height          =   315
         ItemData        =   "frmShippingGuideAE.frx":0038
         Left            =   -73320
         List            =   "frmShippingGuideAE.frx":0042
      ...
      End
   End
   Begin VB.ComboBox cboSendThru 
      Height          =   315
      ItemData        =   "frmShippingGuideAE.frx":0059
      Left            =   9990
      List            =   "frmShippingGuideAE.frx":0066
      Style           =   2  'Dropdown List
      TabIndex        =   76
      Top             =   10200
      Width           =   1815
   ...
   Begin VB.PictureBox picPurchase 
      ...
      Begin VB.ComboBox cboClass 
         Height          =   315
         ItemData        =   "frmShippingGuideAE.frx":0085
         Left            =   6270
         List            =   "frmShippingGuideAE.frx":0087
         Style           =   2  'Dropdown List
         TabIndex        =   39
         Top             =   360
         Width           =   1395
      ...
      End
   End
   Begin VB.TextBox txtCostPerPackage 
      BackColor       =   &H00E6FFFF&
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
   ...
   Begin VB.CommandButton btnRemove 
      Height          =   275
      Left            =   240
      Picture         =   "frmShippingGuideAE.frx":0089
      Style           =   1  'Graphical
      TabIndex        =   8
      ToolTipText     =   "Remove"
      Top             =   4170
