...
Begin VB.Form frmLocations 
   ...
   Begin VB.Label lblTitle 
      BackStyle       =   0  'Transparent
      Caption         =   "Locations/ Routes Records"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
...
Dim rsLocations As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmLocationsAE.State = adStateAddMode
            frmLocationsAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Locations", "RouteID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Locations", "LocationID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "This record has been removed by other user.Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Locations", "LocationID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Route, Desc, RouteID"
        .Tables = "qry_Locations1"
        .SortOrder = "Route ASC"
        
        .SaveStatement
    End With
    
    If rsLocations.State = 1 Then rsLocations.Close
    rsLocations.CursorLocation = adUseClient
    rsLocations.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsLocations, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsLocations, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "RouteID")
    Me.Enabled = True
