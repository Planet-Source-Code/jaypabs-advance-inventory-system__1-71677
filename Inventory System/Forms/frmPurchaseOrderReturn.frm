...
Dim rsPurchaseReturn As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmPOReturnAE.State = adStateAddMode
            frmPOReturnAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Purchase_Order_Return", "POReturnID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                ...
                Else
                    With frmPOReturnAE
                        ...
                        blnStatus = getValueAt("SELECT POReturnID,Status FROM Purchase_Order_Return WHERE POReturnID=" & CLng(LeftSplitUF(lvList.SelectedItem.Tag)), "Status")
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Purchase_Order_Return", "POReturnID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Company, Date, Notes, Gross, NetAmount, POReturnID"
    ...
    rsPurchaseReturn.CursorLocation = adUseClient
    rsPurchaseReturn.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsPurchaseReturn, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsPurchaseReturn, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "POReturnID")
    Me.Enabled = True
