...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "AccountNo, Company, Tin, CategoryID, CreditLimit, Lastname, Firstname, Gender, Address, Mobile, Landline, Fax, Email, Website, StartingBalance, VendorID"
        .Tables = "Vendors"
