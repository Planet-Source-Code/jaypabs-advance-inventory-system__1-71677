...
Dim rsReorder As New Recordset
    ...
    Select Case srcPerformWhat
        ...
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                With frmWeeklyInv
                    .intProductID = CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                    .show vbModal
                End With
            End If
        Case "Search"
...
Private Sub Form_Load()
    ...
    With SQLParser
      .Fields = "Stock, SupplierPrice, Unit, Pending, Incoming, OnHand, StockID"
      .Tables = "qry_Reorder"
      
      .SaveStatement
    End With
    
    rsReorder.CursorLocation = adUseClient
    rsReorder.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsReorder, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "StockID")
    Me.Enabled = True
