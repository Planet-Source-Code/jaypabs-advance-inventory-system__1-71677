...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmProductsAE.State = adStateAddMode
            ...
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    With frmProductsAE
                        ...
                        StockID = CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        
                        blnLocked = getValueAt("SELECT Locked FROM Stocks WHERE StockID=" & StockID, "Locked")
                        ...
                        CN.Execute "UPDATE Stocks SET Locked = True WHERE StockID = " & StockID
                    
                        .State = adStateEditMode
                        .PK = StockID
                        .show vbModal
                        
                        CN.Execute "UPDATE Stocks SET Locked = False WHERE StockID = " & StockID
                    End With
                End If
            End If
        Case "Search"
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Barcode, Stock, Short, SalesPrice, Cost, ReorderPoint, Unit, Category, StockID"
        .Tables = "qry_Stocks"
        .SortOrder = "Stock ASC"
    ...
    rsProducts.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsProducts, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "StockID")
    Me.Enabled = True
