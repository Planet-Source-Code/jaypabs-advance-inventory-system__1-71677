...
Begin VB.Form frmPOReceiveOutofTown 
   ...
   End
End
Attribute VB_Name = "frmPOReceiveOutofTown"
...
Dim rsPurchaseReceive As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmPOReceiveLocalAE.State = adStateAddMode
            frmPOReceiveLocalAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Purchase_Order_Receive_Out_of_Town", "InvoiceID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                ...
                Else
                    With frmPOReceiveLocalAE
                        ...
                        blnStatus = getValueAt("SELECT InvoiceID,Status FROM Purchase_Order_Receive_Out_of_Town WHERE InvoiceID=" & CLng(LeftSplitUF(lvList.SelectedItem.Tag)), "Status")
                        ...
                        .InvoicePK = CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        .show vbModal
                    End With
                End If
            End If
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "PONo, Company, Location, DRNo, DRDate, QtyRcvd, Returned, Status_Alias, Remarks, InvoiceID"
        .Tables = "qry_Purchase_Order_Receive_Out_of_Town"
        .SortOrder = "DRDate DESC"
        
        .SaveStatement
    End With
    
    rsPurchaseReceive.CursorLocation = adUseClient
    rsPurchaseReceive.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsPurchaseReceive, 75
        FillList 1
    End With
...
'redden all orders
  ...
  For i = 1 To lvList.ListItems.Count
    lvList.ListItems(i).SubItems(8) = IIf(lvList.ListItems(i).SubItems(8) = "R", "Received", "Lost")
  Next
End Sub
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsPurchaseReceive, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "InvoiceID")
    Me.Enabled = True
