...
Begin VB.Form frmCustomerBalance 
   Caption         =   "Customer w/ balance"
   ClientHeight    =   6285
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   9015
   ...
   End
End
Attribute VB_Name = "frmCustomerBalance"
        ...
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Clients", "ClientID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    ...
                    Exit Sub
                Else
                    With frmBalancePayment
                        '.State = adStateEditMode
                        .PK = CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        .strCustomer = lvList.SelectedItem.Text
                        .TotalAmount = lvList.SelectedItem.SubItems(6)
                        .show vbModal
                    End With
                End If
            End If
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Company, OwnersName, Address, Landline, CreditTerm, PurchaserName, Balance, ClientID"
        .Tables = "qry_Client_Balance"
