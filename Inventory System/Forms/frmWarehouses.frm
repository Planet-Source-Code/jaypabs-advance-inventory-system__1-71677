...
Dim rsWarehouses As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmWarehousesAE.State = adStateAddMode
            frmWarehousesAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Warehouses", "WarehouseID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "This record has been removed by other user.Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    With frmWarehousesAE
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Warehouses", "WarehouseID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        ...
        .Tables = "Warehouses"
        .SortOrder = "Warehouse ASC"
        
        .SaveStatement
    End With
    rsWarehouses.CursorLocation = adUseClient
    rsWarehouses.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsWarehouses, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsWarehouses, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "WarehouseID")
    Me.Enabled = True
