...
Begin VB.Form frmRptSalesReturn 
   ...
   End
End
Attribute VB_Name = "frmRptSalesReturn"
...
Private Sub cmdPreview_Click()
    ...
    With frmReports
        .strReport = "Sales Return Report"

        If nsdClient.Text = "" Then
            .strWhere = "{qry_rpt_Sales_Return.Date} IN #" & dtpBegDate.Value & "# TO #" & dtpEndDate.Value & "#"
        Else
            .strWhere = "{qry_rpt_Sales_Return.ClientID} = " & nsdClient.BoundText & " " _
                                & "AND {qry_rpt_Sales_Return.Date} IN #" & dtpBegDate.Value & "# TO #" & dtpEndDate.Value & "#"
        End If
