...
Begin VB.Form frmPOReturnAE 
   ...
   Begin VB.ComboBox cboStatus 
      Height          =   315
      ItemData        =   "frmPurchaseOrderReturnAE.frx":0000
      Left            =   7530
      List            =   "frmPurchaseOrderReturnAE.frx":000A
      TabIndex        =   3
      Text            =   "On Hold"
      Top             =   900
      Width           =   2325
   ...
   Begin VB.PictureBox picPurchase 
      ...
      Begin VB.ComboBox cboReturnType 
         Height          =   315
         ItemData        =   "frmPurchaseOrderReturnAE.frx":0021
         Left            =   9810
         List            =   "frmPurchaseOrderReturnAE.frx":002B
         TabIndex        =   44
         Text            =   "Bad"
         Top             =   240
         Width           =   1095
   ...
   Begin VB.CommandButton btnRemove 
      Height          =   275
      Left            =   270
      Picture         =   "frmPurchaseOrderReturnAE.frx":003A
      Style           =   1  'Graphical
      TabIndex        =   15
      ToolTipText     =   "Remove"
      Top             =   4200
   ...
   End
End
Attribute VB_Name = "frmPOReturnAE"
...
Public ReceivePK            As Long 'Variable used for RefNo in stock card
