...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmCargosAE.State = adStateAddMode
            frmCargosAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Cargos", "CargoID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Cargos", "CargoID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Cargo,LooseCargo,CargoID"
        .Tables = "Cargos"
        .SortOrder = "Cargo ASC"
        
        .SaveStatement
    End With
    rsCargos.CursorLocation = adUseClient
    rsCargos.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsCargos, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "CargoID")
    Me.Enabled = True
