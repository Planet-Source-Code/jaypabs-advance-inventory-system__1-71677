...
Begin VB.Form frmRptPurchasesReport 
   ...
   End
End
Attribute VB_Name = "frmRptPurchasesReport"
...
Private Sub cmdPreview_Click()
    ...
    With frmReports
        .strReport = "Purchase Report"

        If nsdVendor.Text = "" Then
            .strWhere = "{qry_Purchases_Report.DeliveryDate} IN #" & dtpBegDate.Value & "# TO #" & dtpEndDate.Value & "#"
        Else
            .strWhere = "{qry_Purchases_Report.VendorID} = " & nsdVendor.BoundText & " " _
                                & "AND {qry_Purchases_Report.DeliveryDate} IN #" & dtpBegDate.Value & "# TO #" & dtpEndDate.Value & "#"
        End If
